...
export default function CustomerLogin() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#0a0a0a' }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          <button onClick={() => setMode('choice')} className="flex items-center gap-2 text-sm mb-6" style={{ color: '#8c8578' }}>
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-extrabold" style={{ fontFamily: "'Unbounded', sans-serif" }}>Connexion Invité</h1>
          </div>
          <form onSubmit={handleSubmit} className="surface-card p-6 space-y-4">
            <div>
              <label className="text-[10px] font-semibold mb-1 block" style={{ color: '#555' }}>{t('login.email')}</label>
            ...
            <div>
              <label className="text-[10px] font-semibold mb-1 block" style={{ color: '#555' }}>{t('login.password')}</label>
          ...
          <p className="text-center text-sm mt-6" style={{ color: '#8c8578' }}>
            {t('login.no_account')}{' '}
            <Link to="/auth/register" className="font-semibold no-underline" style={{ color: '#bfa24e' }}>{t('login.register')}</Link>
          </p>
        </motion.div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#0a0a0a' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          <p className="text-xs tracking-[0.3em] font-semibold mb-3" style={{ color: '#bfa24e', fontFamily: "'IBM Plex Mono', monospace" }}>MISTER-DR</p>
          <h1 className="text-2xl font-extrabold" style={{ fontFamily: "'Unbounded', sans-serif" }}>Bienvenue</h1>
          <p className="text-sm mt-2" style={{ color: '#8c8578' }}>Connectez-vous pour commander</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button onClick={() => { setMode('google'); handleGoogleLogin(); }} className="w-full py-4 text-sm font-semibold rounded-xl flex items-center justify-center gap-3" style={{ background: '#fff', color: '#333', border: '1px solid #ddd' }}>

...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/templates/foodmart/css/vendor.css">
    <link rel="stylesheet" type="text/css" href="/templates/foodmart/style.css">
  ...
  <body>
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="index.html">
                <img src="/templates/foodmart/images/logo.png" alt="logo" class="img-fluid">
              </a>
            </div>
          </div>
    ...
    <section class="py-3" style="background-image: url('/templates/foodmart/images/background-pattern.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="/templates/foodmart/images/product-thumb-1.png" class="img-fluid">
                        </div>
                      </div>
                    </div>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('/templates/foodmart/images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('/templates/foodmart/images/ad-image-2.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper"><div class="swiper-wrapper">{{CATEGORIES}}</div></div>
        </div>
      </div>
    </section>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="/templates/foodmart/images/product-thumb-11.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="/templates/foodmart/images/product-thumb-12.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="/templates/foodmart/images/product-thumb-13.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="/templates/foodmart/images/product-thumb-14.jpg" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
            ...
            <div class="bootstrap-tabs product-tabs">
              ...
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">{{PRODUCTS}}</div>>
    ...
    <section class="py-5">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-danger mb-3" style="background: url('/templates/foodmart/images/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-info" style="background: url('/templates/foodmart/images/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
              <div class="banner-content p-5">
            ...
            <div class="products-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="/templates/foodmart/images/thumb-tomatoes.png"  class="tab-image">
                    </a>
                  </figure>
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="/templates/foodmart/images/thumb-tomatoketchup.png"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="index.html" title="Product Title">
                      <img src="/templates/foodmart/images/thumb-bananas.png"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
    ...
    <section class="py-5">
      <div class="container-fluid">
        ...
        <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('/templates/foodmart/images/bg-leaves-img-pattern.png') no-repeat;">
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="/templates/foodmart/images/post-thumb-1.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="/templates/foodmart/images/post-thumb-2.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="/templates/foodmart/images/post-thumb-3.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
    ...
    <section class="py-5 my-5">
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('/templates/foodmart/images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="/templates/foodmart/images/phone.png" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <img src="/templates/foodmart/images/app-store.jpg" alt="app-store">
                  <img src="/templates/foodmart/images/google-play.jpg" alt="google-play">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="/templates/foodmart/images/logo.png" alt="logo">
    ...
    <script src="/templates/foodmart/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="/templates/foodmart/js/plugins.js"></script>
    <script src="/templates/foodmart/js/script.js"></script>
  </body>
</html>`;
...
export default {
  ...
  description: 'Bootstrap 5 épicerie/grocery — design moderne, Swiper carousel, tons verts & orange',
  preview: '',
  theme: {

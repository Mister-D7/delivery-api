...
<head>
<meta charset="utf-8">
<title>{{STORE_NAME}} - Shop</title>
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet">
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
<link href="/templates/eshopper/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
<link href="/templates/eshopper/css/style.css" rel="stylesheet">
</head>
<body>
  ...
  <div class="row align-items-center py-3 px-xl-5">
    <div class="col-lg-3 d-none d-lg-block">
      <a href="" class="text-decoration-none">
        <h1 class="m-0 display-5 font-weight-semi-bold">{{STORE_NAME}}</h1>
      </a>
    </div>
  ...
  <div class="row border-top px-xl-5">
    <div class="col-lg-3 d-none d-lg-block">
      ...
      <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
        <div class="navbar-nav w-100 overflow-hidden" style="height:410px" id="categoryNav">
          {{CATEGORIES}}
        </div>
      </nav>
    </div>
      ...
      <div id="header-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active" style="height:410px;">
            <img class="img-fluid" src="/templates/eshopper/img/carousel-1.jpg" alt="">
          ...
          <div class="carousel-item" style="height:410px;">
            <img class="img-fluid" src="/templates/eshopper/img/carousel-2.jpg" alt="">
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
              <div class="p-3" style="max-width:700px;">
                <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
...
<div class="container-fluid pt-5">
  ...
  <div class="row px-xl-5 pb-3" id="productGrid">{{PRODUCTS}}</div>
</div>
...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
  <div class="row px-xl-5 pt-5">
    <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
      <a href="" class="text-decoration-none">
        <h1 class="mb-4 display-5 font-weight-semi-bold">{{STORE_NAME}}</h1>
      </a>
      <p>Your trusted online store for quality products at great prices.</p>
      <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, New York, USA</p>
      <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
      <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+01 234 567 890</p>
    </div>
  ...
  <div class="row border-top border-light mx-xl-5 py-4">
    <div class="col-md-6 px-xl-0">
      <p class="mb-md-0 text-center text-md-left text-dark">
        &copy; <a class="text-dark font-weight-semi-bold" href="#">{{STORE_NAME}}</a>. All Rights Reserved.
      </p>
    </div>
    <div class="col-md-6 px-xl-0 text-center text-md-right">
      <img class="img-fluid" src="/templates/eshopper/img/payments.png" alt="">
    </div>
  </div>
</div>
...
<script src="/templates/eshopper/lib/easing/easing.min.js"></script>
<script src="/templates/eshopper/lib/owlcarousel/owl.carousel.min.js"></script>
<script src="/templates/eshopper/js/main.js"></script>
</body>
</html>`;
...
export default {
  ...
  description: 'Bootstrap 4 shop général — tons rose poudré et bleu pastel',
  preview: '',
  theme: {

...
<head>
<meta charset="utf-8">
<title>{{STORE_NAME}} - Electro</title>
...
<link href="/templates/electro/lib/animate/animate.min.css" rel="stylesheet">
<link href="/templates/electro/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="/templates/electro/css/style.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="col-md-4 col-lg-3 text-center text-lg-start">
      <div class="d-inline-flex align-items-center">
        <a href="" class="navbar-brand p-0">
          <h1 class="display-5 text-primary m-0"><i class="fas fa-shopping-bag text-secondary me-2"></i>{{STORE_NAME}}</h1>
        </a>
      </div>
    </div>
      ...
      <nav class="navbar navbar-light position-relative" style="width:250px;">
        ...
        <div class="collapse navbar-collapse rounded-bottom" id="allCat">
          <div class="navbar-nav ms-auto py-0">
            <ul class="list-unstyled categories-bars" id="categoryList">{{CATEGORIES}}</ul>
          </div>
        </div>
      </nav>
    </div>
    <div class="col-12 col-lg-9">
      <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <a href="" class="navbar-brand d-block d-lg-none">
          <h1 class="display-5 text-secondary m-0"><i class="fas fa-shopping-bag text-white me-2"></i>{{STORE_NAME}}</h1>
        </a>
  ...
  <div class="row g-0 justify-content-end">
      ...
      <div class="header-carousel owl-carousel bg-light py-5">
        <div class="row g-0 header-carousel-item align-items-center">
          <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
            <img src="/templates/electro/img/carousel-1.png" class="img-fluid w-100" alt="">
          </div>
          <div class="col-xl-6 carousel-content p-4">
            <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s" style="letter-spacing:3px;">Save Up To $400</h4>
        ...
        <div class="row g-0 header-carousel-item align-items-center">
          <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
            <img src="/templates/electro/img/carousel-2.png" class="img-fluid w-100" alt="">
          </div>
          <div class="col-xl-6 carousel-content p-4">
            <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight" data-wow-delay="0.1s" style="letter-spacing:3px;">Save Up To $200</h4>
            <h1 class="display-3 text-capitalize mb-4 wow fadeInRight" data-wow-delay="0.3s">On Selected Laptops & Desktop Or Smartphone</h1>
            <p class="text-dark wow fadeInRight" data-wow-delay="0.5s">Terms and Condition Apply</p>
            <a class="btn btn-primary rounded-pill py-3 px-5 wow fadeInRight" data-wow-delay="0.7s" href="#">Shop Now</a>
          </div>
    ...
    <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
      <div class="carousel-header-banner h-100">
        <img src="/templates/electro/img/header-img.jpg" class="img-fluid w-100 h-100" style="object-fit:cover;" alt="">
    ...
    <div class="row g-4">
      <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
        <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
          ...
          <img src="/templates/electro/img/product-1.png" class="img-fluid" alt="">
        </a>
      </div>
      <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
        <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
          ...
          <img src="/templates/electro/img/product-2.png" class="img-fluid" alt="">
        </a>
      </div>
    </div>
  </div>
    ...
    <div class="tab-class">
      ...
      <div class="tab-content">
        <div id="tab-1" class="tab-pane fade show p-0 active">
          <div class="row g-4" id="productGrid">{{PRODUCTS}}</div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
        <a href="#">
          <div class="bg-primary rounded position-relative">
            <img src="/templates/electro/img/product-banner.jpg" class="img-fluid w-100 rounded" alt="">
      ...
      <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
        <a href="#">
          <div class="text-center bg-primary rounded position-relative">
            <img src="/templates/electro/img/product-banner-2.jpg" class="img-fluid w-100" alt="">
  ...
  <div class="container">
    <div class="row g-4 align-items-center">
      <div class="col-md-6 text-center text-md-start mb-md-0">
        <span class="text-white"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>{{STORE_NAME}}</a>, All right reserved.</span>
      </div>
...
<script src="/templates/electro/lib/wow/wow.min.js"></script>
<script src="/templates/electro/lib/owlcarousel/owl.carousel.min.js"></script>
<script src="/templates/electro/js/main.js"></script>
</body>
</html>`;
...
export default {
  ...
  description: 'Bootstrap tech store avec carousel, offres et grille produits — tons bleu et orange',
  preview: '',
  theme: {
